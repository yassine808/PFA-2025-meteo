...
def scrape_rabat_weather():
    ...
    try:
        ...
        # Feels-like temperature (fixed logic)
        feels_like_span = soup.select_one("div.temp_selected_ville_part2 span")
        weather_data["Ressentie"] = extract_temperature(feels_like_span.get_text() if feels_like_span else None)
